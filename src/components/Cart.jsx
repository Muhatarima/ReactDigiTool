function Cart({ cart, removeCart }) {
  return (
    <div className="max-w-6xl mx-auto mt-4 ">
      ...
      {cart.length === 0 ? (
        <p className="font-bold mt-2 mb-6 text-4xl">Your cart is empty</p>
      ) : (
        cart.map((product) => (
          <div key={product.id} className="flex justify-evenly bg-slate-200 shadow-lg mt-8 mb-4 px-5 py-4">
